...
namespace F122::Network {
    ...
    PacketMotionData::Data::Data(const std::array<std::uint8_t, 60>& bytes) :
            ...
            m_worldForwardDirX{util::convert<int16>({bytes[24], bytes[25]})},
            m_worldForwardDirY{util::convert<int16>({bytes[26], bytes[27]})},
            m_worldForwardDirZ{util::convert<int16>({bytes[28], bytes[29]})},
            m_worldRightDirX{util::convert<int16>({bytes[30], bytes[31]})},
            m_worldRightDirY{util::convert<int16>({bytes[32], bytes[33]})},
            m_worldRightDirZ{util::convert<int16>({bytes[34], bytes[35]})},
