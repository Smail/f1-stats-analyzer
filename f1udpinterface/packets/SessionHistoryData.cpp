...
namespace F122::Network::Packets {
    SessionHistoryData::LapHistoryData::LapHistoryData(const std::array<std::uint8_t, 11>& bytes) :
    ...
    SessionHistoryData::TyreStintHistoryData::TyreStintHistoryData(const std::array<std::uint8_t, 3>& bytes) :
            m_endLap{bytes[0]},
            m_tyreActualCompound{bytes[1]},
            m_tyreVisualCompound{bytes[2]} {}

    SessionHistoryData::SessionHistoryData(const std::array<std::uint8_t, 1155>& bytes) :
